...
public class TestGameBoardMem {
    ...
    private IGameBoard IGameFactory(int row, int column, int tokens) {
        return new GameBoardMem(row, column, tokens);
    }
    ...
    /**
     * <p>
     *     This is a test case for testing {@link GameBoardMem#GameBoardMem(int userRow, int userCol, int token)} where we test
     *     the gameboard initializes correctly and only has blank space characters.
     * </p>
     */
    @Test
    public void testGameBoardMem_Constructor_empty_array_initialized() {
     ...
     * <p>
     *     This is a test case for testing {@link GameBoardMem#GameBoardMem(int userRow, int userCol, int token)} where we test
     *     the gameboard initializes correctly with the minimum amount of rows, columns, and # of tokens
     ...
     * <p>
     *     This is a test case for testing {@link GameBoardMem#GameBoardMem(int userRow, int userCol, int token)} where we test
     *     the gameboard initializes correctly with maximum number of rows, columns, and # of tokens
     *     and only has blank space characters.
     * </p>
     */
    @Test
    ...
    /**
     * <p>
     *     This is a test case for testing {@link GameBoardMem#checkIfFree(int c)} where we
...
//CheckHorizWin #1
    ...
    /**
     * <p>
     *     This is a test case for testing {@link GameBoardMem#checkTie()} where we
    ...
    /**
     * <p>
     *     This is a test case for testing {@link GameBoardMem#whatsAtPos(BoardPosition)} where we check that the function
    ...
    public void testWhatsAtPos_empty_pos() {
        ...
        for (int i = 0; i < 2; i++) {
            gb.dropToken(player2, lastCol);
            expected[i][lastCol] = player2;
        }
    ...
    public void testWhatsAtPos_bottom_row_pos() {
        ...
        for (int i = 0; i < 2; i++) {
            gb.dropToken(player2, firstCol);
            expected[i][firstCol] = player2;
        }
    ...
    public void testWhatsAtPos_top_row_pos() {
        ...
        assertEquals(expPlayer, gb.whatsAtPos(pos));
    ...
    /**
     * <p>
     *     This is a test case for testing {@link GameBoardMem#isPlayerAtPos(BoardPosition pos, char player)} where we
    ...
    /**
     * <p>
     *     This is a test case for testing {@link GameBoardMem#dropToken(char p, int c)} where we
